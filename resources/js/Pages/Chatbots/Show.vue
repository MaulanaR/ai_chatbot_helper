        ...
        <template #header>
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                ...
                <div class="flex items-center gap-3 ml-10 sm:ml-0">
                    <Link :href="route('chatbots.analytics', chatbot.id)" class="inline-flex items-center px-4 py-2 rounded-xl bg-white text-gray-700 font-medium text-sm border border-gray-200 hover:bg-gray-50 hover:text-gray-900 transition-all shadow-sm">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <GlassCard title="Live Preview">
                    <div class="relative">
                        <h3>Widget Example (Full chat)</h3>
                ...
                <GlassCard title="Live Preview">
                    <div class="relative">
                        <h3>Widget Example (Bubble chat)</h3>
                        <div class="absolute top-0 right-0 flex items-center gap-2">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700">
                                <span class="w-2 h-2 bg-green-500 rounded-full mr-1.5 animate-pulse"></span>
                                Live
                            ...
                            <button 
                                @click="openWidget(widgetBubbleUrl)" 
                                class="text-gray-500 hover:text-indigo-600 transition-colors p-1.5 rounded-lg hover:bg-gray-100"
                                title="Open in new tab"
                            >
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
